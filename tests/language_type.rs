...
mod language_type {
    ...
    mod c {
        ...
        fn extract_entities() {
            ...
            let c_test_src_path = Path::new("tests").join("testdata").join("c_sources").join(
                "language_type",
            );
            assert!(
                analysis
            ...
            assert!(C::extract_entities(&analysis).is_ok());
    ...
    mod python {
        ...
        use thinlinelib::language_type::{LanguageType, Python};
        ...
        fn extract_entities() {
            ...
            assert!(Python::extract_entities(&analysis).is_ok());
